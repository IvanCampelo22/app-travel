...
@InputType()
export class AccountUncheckedUpdateManyWithoutTenantNestedInput {
  ...
  @Field(() => [AccountUpsertWithWhereUniqueWithoutTenantInput], {
    nullable: true
  })
