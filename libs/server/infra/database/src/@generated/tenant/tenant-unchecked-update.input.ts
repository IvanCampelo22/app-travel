...
import { AccountUncheckedUpdateManyWithoutTenantNestedInput } from '../account/account-unchecked-update-many-without-tenant-nested.input';
...
export class TenantUncheckedUpdateInput {
    ...
    @Field(() => AccountUncheckedUpdateManyWithoutTenantNestedInput, {nullable:true})
    Account?: AccountUncheckedUpdateManyWithoutTenantNestedInput;
}
