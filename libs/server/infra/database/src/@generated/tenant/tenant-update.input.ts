...
import { AccountUpdateManyWithoutTenantNestedInput } from '../account/account-update-many-without-tenant-nested.input';
...
export class TenantUpdateInput {
    ...
    @Field(() => AccountUpdateManyWithoutTenantNestedInput, {nullable:true})
    Account?: AccountUpdateManyWithoutTenantNestedInput;
}
